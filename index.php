...
<head>
    ...
    <link rel="icon" href="#">
    <title>Easy Food Delivery </title>
    <!-- Bootstrap core CSS -->
...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> EASY FOOD DELIVERY </a>
						...
						if(empty($_SESSION["user_id"])) // if user is not login
							{
							  ...
							  <li class="nav-item"><a href="registration.php" class="nav-link active">New User</a> </li>';
							}
						else
							{
									//if user is login
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Easy Food Delivery </h1>
                    <h5 class="font-white space-xs">Find restaurants, Order, and Eat. That all!</h5>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>The Best Food Delivery Online</h3>
